...
final class NasaAssetRepoImpl: NasaAssetRepo {
    ...
    func search(text: String?, center: String?, description: String?, description508: String?, keywords: [String]?, location: String?, mediaType: [NasaAsset.Item.Data.MediaType]?, nasaId: String?, page: Int?, photographer: String?, secondaryCreator: String?, title: String?, yearStart: Int?, yearEnd: Int?) async throws -> NasaAsset {
